# compare_optimizers_mnist_resnet18_adabobr.py
...
def build_resnet18_mnist(num_classes=10):
    ...
    # MNIST images are grayscale, so input channel = 1.
    # We resize MNIST to 32x32 and use a CIFAR-style first convolution.
...
def train_one_optimizer(
    ...
    for epoch in range(1, epochs + 1):
        ...
        print(
            ...
            f"Test Macro P {test_precision:.2f}% | "
            f"Test Macro R {test_recall:.2f}% | "
            f"Test Macro F1 {test_f1:.2f}%"
        )
...
def final_epoch_summary(df):
    ...
    return final_df[cols].sort_values("test_macro_f1", ascending=False)
...
def main():
    ...
    OUT_DIR = "mnist_resnet18_optimizer_results"
    ...
    print("\n==========================================")
    print("MNIST ResNet-18 Optimizer Comparison")
    print("==========================================\n")
    ...
    print("\n==========================================")
    print("Final MNIST ResNet-18 Summary")
    print("==========================================")
