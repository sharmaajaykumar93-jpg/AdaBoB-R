# compare_optimizers_cifar10_resnet18_adabobr_clean.py
...
def plot_metric(df, metric, title, ylabel, save_path, is_accuracy=False):
    ...
    # Let matplotlib automatically choose the y-axis range
    # if is_accuracy:
    #     plt.ylim(0, 100)
...
def make_all_plots(clean_df, out_dir):
    os.makedirs(out_dir, exist_ok=True)

    plot_metric(
        clean_df,
        "train_loss",
        "CIFAR-10 ResNet-18 Train Loss",
        "Train Loss",
    ...
    plot_metric(
        clean_df,
        "test_loss",
        "CIFAR-10 ResNet-18 Test Loss",
        "Test Loss",
        os.path.join(out_dir, "test_loss.png"),
        is_accuracy=False
    )
    ...
    plot_metric(
        clean_df,
        "train_acc",
        "CIFAR-10 ResNet-18 Train Accuracy",
        "Train Accuracy (%)",
    ...
    plot_metric(
        clean_df,
        "test_acc",
        "CIFAR-10 ResNet-18 Test Accuracy",
        "Test Accuracy (%)",
        os.path.join(out_dir, "test_accuracy.png"),
        is_accuracy=True
    )
...
def final_epoch_summary(df):
    ...
    return final_df[cols].sort_values("macro_f1", ascending=False)
...
def main():
    ...
    OUT_DIR = "cifar10_resnet18_optimizer_results"
    ...
    print("\n==========================================")
    print("CIFAR-10 ResNet-18 Optimizer Comparison")
    print("==========================================\n")
    ...
    print("\n==========================================")
    print("Final CIFAR-10 ResNet-18 Summary")
    print("==========================================")
