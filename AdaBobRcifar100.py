# compare_optimizers_cifar100_resnet18_adabobr_clean.py
...
def build_resnet18_cifar100(num_classes=100):
...
def train_one_optimizer(
    ...
    model = build_resnet18_cifar100(num_classes=100).to(DEVICE)
...
def plot_metric(df, metric, ylabel, save_path):
    ...
    # Accuracy, precision, recall, and F1 are already stored as percentages.
...
def main():
    ...
    OUT_DIR = "cifar100_resnet18_optimizer_results"
    ...
    print("\n==========================================")
    print("CIFAR-100 ResNet-18 Optimizer Comparison")
    print("==========================================\n")
    ...
    print("\n==========================================")
    print("Final CIFAR-100 ResNet-18 Summary")
    print("==========================================")
